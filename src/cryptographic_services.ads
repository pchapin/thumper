...
private
   ...
   type Word_Array is array (Natural range <>) of Word; pragma Pack (Word_Array);
   subtype Word16 is Word_Array(0 .. 15);
   subtype Word64 is Word_Array(0 .. 63);
   type State_H is array(Integer range 0 .. 7) of Word;
   type Array64 is new Word range 0 .. 63;
   type Nat64 is new Natural range 0 .. 64;

   K : constant array (Array64) of Word
