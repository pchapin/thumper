...
package body Hermes.DER.Encode is
   ...
   function Put_Integer_Value(Value : Integer) return Hermes.Octet_Array is
      ...
      Oct2 : Hermes.Octet; -- second Octet to store Integer Value
      Oct3 : Hermes.Octet; -- third Octet to store Integer Value
      Oct4 : Hermes.Octet; -- fourth Octet to store Integer Value
      val1 : Natural;
      val2 : Natural;
      val3 : Natural;
      val4 : Natural;
