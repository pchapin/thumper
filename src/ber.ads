...
package BER is
   ...
   type Status_Type is (Success, Bad_Identifier, Indefinite_Length, Unimplemented_Length, Bad_Length);
   ...
   --   Fails with Unimplemented_Length if the encoded length is too large for this implementation to handle. In that case
   --     the returned value of Stop points at the last octet of the full length.
   --
